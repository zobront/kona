...
## [0.0.5](https://github.com/zobront/kona/compare/kona-preimage-v0.0.4...kona-preimage-v0.0.5) - 2024-11-20

### Added

- *(preimage)* Decouple from `kona-common` ([#817](https://github.com/zobront/kona/pull/817))

### Other

- *(driver)* use tracing macros ([#823](https://github.com/zobront/kona/pull/823))
- *(workspace)* Reorganize SDK ([#816](https://github.com/zobront/kona/pull/816))
