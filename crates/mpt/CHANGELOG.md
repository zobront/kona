...
## [0.0.7](https://github.com/zobront/kona/compare/kona-mpt-v0.0.6...kona-mpt-v0.0.7) - 2024-11-20

### Added

- *(mpt)* Extend `TrieProvider` in `kona-executor` ([#813](https://github.com/zobront/kona/pull/813))

### Fixed

- *(mpt)* Remove unnused collapse ([#808](https://github.com/zobront/kona/pull/808))
